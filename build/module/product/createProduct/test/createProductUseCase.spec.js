...
(0, globals_1.describe)('US-1 : Créer un produit', function () {
    ...
    (0, globals_1.test)("Scénario 2 bis : echec, description contenant '@'", function () { return __awaiter(void 0, void 0, void 0, function () {
        var createProductRepository, createProductUseCase;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    createProductRepository = new CreateProductDummyRepository();
                    createProductUseCase = new createProductUseCase_1.CreateProductUseCase(createProductRepository);
                    return [4 /*yield*/, (0, globals_1.expect)(createProductUseCase.execute({
                            title: 'switch 2',
                            description: 'nouvelle@console',
                            price: 500
    ...
    (0, globals_1.test)('Scénario 2 ter : echec, titre commençant par un espace', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createProductRepository, createProductUseCase;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
